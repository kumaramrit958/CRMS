...
<body>
    <!-- banner-inner -->
    <div id="demo-1" data-zs-src='["images/01.jpg", "images/9.jpg","images/a1.jpg", "images/11.jpg", "images/24.jpg"]' data-zs-overlay="dots">
        ...
        <div class="container">
			...
			<!---728x90--->
                <h3 class="tittle text-center mb-lg-4 mb-3">
                    ...
                    <span>Some Info</span><marquee>Latest Job flow-positions</marquee></h3>
					<!---728x90--->
                <div class="tabs mt-5">
